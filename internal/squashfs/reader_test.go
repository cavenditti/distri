...
func TestReaddir(t *testing.T) {
	...
	f, err := os.Open("~/distri/build/distri/pkg/ack-amd64-2.24.squashfs")
	if err != nil {
		t.Fatal(err)
	}
	defer f.Close()
...
func TestReaddirSmoke(t *testing.T) {
	...
	for _, fn := range []string{
		...
		// blocks.
		"~/distri/build/distri/pkg/bash-amd64-4.4.18.squashfs",

		// cmake exercises the code path where the root directory entries are
		// located outside of the first block.
		"~/distri/build/distri/pkg/cmake-amd64-3.12.2.squashfs",
	} {
		// TODO: ship testdata files generated by mksquashfs
		f, err := os.Open(fn)
		if err != nil {
...
func TestReaddirEmpty(t *testing.T) {
	t.Parallel()
	// TODO: ship testdata files generated by mksquashfs
	f, err := os.Open("~/distri/build/distri/pkg/zlib-amd64-1.2.11.squashfs")
	if err != nil {
		t.Fatal(err)
	}
	defer f.Close()
